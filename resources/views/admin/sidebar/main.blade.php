...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="images/logo_travelclass.png" />
...
<div class="wrapper">
  ...
  <aside class="main-sidebar bg-light color-palette">
    ...
    <a href="#" class="brand-link">
      <span class="brand-text font-weight-light">TravelClass</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" id="sidebar-users">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('admin.data_pembayaran')}}" class="nav-link">
                  <i class="fa-solid fa-caret-right"></i>
                  <p>Pembayaran Pending</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('admin.data_pembayaranAccept')}}" class="nav-link">
                  <i class="fa-solid fa-caret-right"></i>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="">TravelClass</a>.</strong>
    All rights reserved.
