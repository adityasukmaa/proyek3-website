...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <a href=" {{ route('bus.halcreate') }} " class="btn btn-primary mb-3">Tambah Data</a>
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Mobil Management</h3>
                ...
                <tbody>
                  @foreach ($bus as $u)
                    ...
                    <tr>
                      ...
                      <td>
                        @if($u->image)
                            <img src="{{ asset('storage/photo-bus/'.$u->image)}}" width="100" height="100" alt="">
                        @else
                            <img src="{{ asset('../images/no-image.jpg') }}" width="100" height="100" alt="No Image">
                        @endif
                    </td>
                      <td>{{ $u->nomor_plat }}</td>
                      <td>{{ $u->nama }}</td>
                      <td>{{ $u->jenis }}</td>
                      <td>{{ $u->fasilitas }}</td>
                      <td>{{ $u->jumlah_kursi }}</td>
                      <td>{{ $u->format_kursi }}</td>

                      <td>
                        <a href="{{ route('bus.edit',['id' =>$u->id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-pen"></i> Edit</a>
