             ...
             <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputNomorPlat">Photo Mobil</label><br>
                    @if($bus->image)
                        <img src="{{ asset('storage/photo-bus/'.$bus->image) }}" width="100" height="100" alt="Gambar Mobil">
                        <br><br>
                    @endif
                    ...
                    <div class="form-group">
                        <label for="inputNomorPlat">Nama Mobil</label>
