            ...
            <div class="card card-primary">
             ...
             <form>
               <div class="card-body">
                ...
                <div class="form-group">
                    <label for="terminal_asal_id">Travel Asal:</label>
                ...
                <div class="form-group">
                    <label for="terminal_tujuan_id">Travel Tujuan:</label>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_sampai" class="form-control" id="tanggal_sampai">
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="jam_sampai" class="form-control" id="jam_sampai">
                    @error('jam_sampai')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="destinasi_waktu" class="form-control" id="destinasi_waktu" placeholder="contoh : 1j20m">
                ...
                <div class="form-group">
                    <label for="bus_id">Mobil:</label>
                    <!-- Saat membuat dropdown untuk memilih bus -->
                    <select name="bus_id" class="form-control" id="bus_id">
                        <option value="">Pilih Mobil</option>
                        @foreach ($bus as $b)
                            <option value="{{ $b->id }}" data-jumlah-kursi="{{ $b->jumlah_kursi }}" data-image="{{ asset('storage/photo-bus/' . $b->image) }}" data-fasilitas="{{ $b->fasilitas }}" data-jenis="{{ $b->jenis }}">
                                {{ $b->nama }} - {{ $b->nomor_plat }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="harga_tiket" id="harga_tiket" class="form-control" placeholder="0.00">
