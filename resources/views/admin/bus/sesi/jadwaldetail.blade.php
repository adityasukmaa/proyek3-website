                ...
                <div class="card-body" >
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="terminalAsal">Travel Asal:</label>
                            ...
                            <div class="form-group">
                                <label for="terminalTujuan">Travel Tujuan:</label>
                            ...
                            <div class="form-group gray-container" id="bus_image_container">
                                <div class="flex-container">
                                    <div class="bus-container">
                                        <label style="margin-right: 10px;" for="bus_image">Foto Mobil:</label>
                                        <img src="{{ asset('storage/photo-bus/' . $jadwal->bus->image) }}" alt="Foto Mobil" id="bus_image" style="width: 200px; height: 200px; border-radius: 5px;">
                                    </div>
                                    ...
                                    <div class="fasilitas-container">
                                        ...
                                        <div>
                                            <label style="margin-top: 10px;">Jenis Mobil:</label>
