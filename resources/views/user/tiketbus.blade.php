    ...
    <header>
        <div class="logo">
            <a class="navbar-brand">
                <span style="color: #000000;">TRAVEL</span><b style="color: #000000;">CLASS</b>
            </a>
        </div>
                          ...
                          <div class="fitur-container" style="display: none;">
                              ...
                              <div class="row2">
                                          ...
                                          <div class="flex-container">
                                              <div class="bus-container" style="width: auto">
                                                  <div class="refund-info">
                                                      ...
                                                      <p class="other-info raleway-font" style="font-weight:700; opacity: 0.5; font-size:15px; margin-top:0px;">Tiket travel yang sudah dibeli tidak bisa dibatalkan</p>
                                                  </div>                                                
                                              </div>
                                          </div>
                                      </div>
                                  ...
                                  <div class="columndetail" style="width: 40%;">
                                      <img src="{{ asset('storage/photo-bus/' . $jadwalitem->bus->image) }}" alt="Foto Travel" id="bus_image" style="width: 100%; height: 100%; border-radius: 5px; margin-left: 100px; margin-right:15px; margin-top:15%; ">
                                  </div>
